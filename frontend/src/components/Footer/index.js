        ...
        <div id="splash-footer-container">
            <div id="splash-footer-nav">
                ...
                <div id="splash-footer-buttons">
                    ...
                    <a className="technology-link" href='https://reactjs.org/docs/getting-started.html'><img className='tech-2' id="react-logo" src={ ReactLogo }></img></a>
